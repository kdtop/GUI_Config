...
{UniqueAutoComplete Was added as a result of the following defects:
 ...
 7284 - Inconsistencies of pulling in a dose from the Possible Dose File }
  ...
  protected
    procedure Loaded; override;
    procedure Resize; override;
    procedure ClearSizes;  //kt added
  public
    destructor Destroy; override;
    procedure RefreshSizes;  //kt added
  end;
...
var
  ...
  i: Integer;
begin
  ClearSizes; //kt added, and commented equivalent block below.
  {
...
procedure TORAutoPanel.ClearSizes;
//kt added
var
  SizeRatio: TSizeRatio;
  i: Integer;
begin
  if not assigned(FSizes) then exit;
  with FSizes do for i := 0 to Count - 1 do begin
    SizeRatio := Items[i];
    SizeRatio.Free;
  end;
  FSizes.Clear;
...
procedure TORAutoPanel.RefreshSizes;  //kt added
begin
  ClearSizes;
  BuildSizes(Self);
end;
