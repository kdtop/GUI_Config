...
begin
  ...
  TMGRPCName := RPCBrokerV.RemoteProcedure; //kt
  if TMGRPCName = 'TMG CHANNEL' then begin
    TMGRPCName := TMGRPCName + ' [' + Piece(RPCBrokerV.Param[0].Mult['"REQUEST"'],'^',1) + ']';
  end;
  AStringList.Add(TMGRPCName);
  //kt AStringList.Add(RPCBrokerV.RemoteProcedure);
