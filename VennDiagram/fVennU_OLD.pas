...
type
  ...
  public
    ...
    Property OnDisplayRefreshNeeded : TNotifyEvent read FOnDisplayRefreshNeeded;
  end;
...
{$R IMAGES.res}
  ...
  Uses
    LogUnit, MainU, OneRecEditU, Rem2VennU, fAddRemFinding, fTestReminder;
  ...
  //function TVennForm.AddVennObject : TVennObj;
  ...
  begin
    ...
    //RgnMgr.AnimateAndRender(ScreenToClient(Mouse.CursorPos));
  end;

  //procedure TVennForm.HandleSelectionChange(VennObject : TVennObj);
...
procedure TVennForm.btnDetailsClick(Sender: TObject);
  ...
  begin
    ...
    //GridInfo := TGridInfo(RgnMgr.SelVennObject.ObjectPtr);
