...
//kt function  MakeDCSummTreeObject(x: string): PDocTreeObject;
//kt function  MakeConsultsNoteTreeObject(x: string): PDocTreeObject;

implementation

//kt uses
  //kt rConsults, uDCSumm, uConsults;
        ...
        begin
          ...
          if Piece(Strings[i], U, 13) <> '%' then
            case TabIndex of
                ...
                //kt CT_CONSULTS: Name := MakeConsultNoteDisplayText(Strings[i]);
                //kt CT_DCSUMM:   Name := MakeDCSummDisplayText(Strings[i]);
            end
          else
          ...
          if (tmpNode <> nil) and tmpNode.HasAsParent(Node) then
            ...
            begin
              case TabIndex of
                ...
                //kt CT_CONSULTS: AnObject := MakeConsultsNoteTreeObject(Strings[i]);
                //kt CT_DCSUMM:   AnObject := MakeDCSummTreeObject(Strings[i]);
              else
                AnObject := nil;
              end;
