...
interface
uses
  Classes, Controls, SysUtils, Forms, ORFn, ORNet, Dialogs, MSXML_TLB,
  uTIU, {uDCSumm, }Variants;
...
//kt function MakeXMLParamTIU(ADCSummID: string; ADCSummRec: TEditDCSummRec): string;  overload;
...
function CanEditLinkType(LinkType: TTemplateLinkTypes): boolean;
  ...
  begin
    ...
    begin
      //Result := IsUserTemplateEditor(Template.ID, User.DUZ);  //kt
      Result := false; //kt 
