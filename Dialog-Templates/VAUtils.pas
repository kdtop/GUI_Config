...
//kt function GetInstanceCount(ApplicationNameAndPath: string): integer; overload;
//ktfunction GetInstanceCount: integer; overload;

//kt function AnotherInstanceRunning: boolean;
