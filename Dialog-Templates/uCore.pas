...
type
  ...
  public
    ...
    //kt property CombatVet:        TCombatVet  read GetCombatVet;
  end;
...
begin
  ...
  //kt if ItemType = CH_ORD then UnlockOrder(AnID);
...
begin
  ...
  try
    ...
    //kt LoadUnsignedOrders(OtherOrders, HaveOrders);
    ...
    begin
      ...
      //kt Add(CH_ORD, AnID, TextForOrder(AnID), 'Other Unsigned', CanSign,'', OrderUser, Display, IsDiscontinue, IsDelay);
    end;
  finally
    StatusText('');
    HaveOrders.Free;
