...
uses
  ...
  TypInfo, StrUtils, ORCtrls, ORDtTm, Forms, Graphics, Dialogs, RTLConsts,
...
type
  ...
  //kt TCPRSDialogYearEdit = class(TORYearEdit);
...
//kt procedure ScreenReaderSystem_CurrentCheckBox(CheckBox: TCPRSDialogParentCheckBox);
//kt procedure ScreenReaderSystem_CurrentLabel(lbl: TCPRSDialogStaticLabel);
//kt procedure ScreenReaderSystem_CurrentComponent(component: ICPRSDialogComponent);
//kt procedure ScreenReaderSystem_AddText(text: string);
//kt procedure ScreenReaderSystem_Continue;
//kt procedure ScreenReaderSystem_Stop;
//kt procedure ScreenReaderSystem_Clear;
...
begin
  ...
  //self.Color := DlgBackgroundColor; //kt added
  //self.Color := clYellow; //kt added
end;
...
begin
  inherited Create(AOwner);
  //kt ORYearEditClass :=  TCPRSDialogYearEdit;
...
begin
  ...
  //kt Font.Color := Get508CompliantColor(clBlue);
