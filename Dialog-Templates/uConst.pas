...
//  UM_DELAYEVENT   = (WM_USER + 110);  // used with PostMessage to slightly delay an event
  ...
  CT_WEBTAB1  = 12;                             // chart tab - web browser //kt 9/11
  CT_WEBTAB2  = 13;                             // chart tab - web browser //kt 9/11
  CT_WEBTAB3  = 14;                             // chart tab - web browser //kt 9/11
  //kt 9/11 NOTE  --> Option: add more CT_WEBTAB#'s here. But set CT_LASTWEBTAB= to last
  CT_LAST_WEBTAB = CT_WEBTAB3;                  // Last web chart tab //kt 9/11 
