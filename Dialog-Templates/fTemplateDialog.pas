...
uses
  ...
  StdCtrls, ExtCtrls, ORCtrls, ORFn, AppEvnts, uTemplates, {fBase508Form,}
  fRptBox,
  uConst{, VA508AccessibilityManager};
...
type
  ...
  private
    ...
    //kt procedure UMScreenReaderInit(var Message: TMessage); message UM_MISC;
    //kt procedure InitScreenReaderSetup;
  public
    ...
    begin
      ...
      repeat                      
         ...
         if(frmTemplateDialog.ModalResult = mrOK) then
          ...
          if (not PreviewMode) and (not frmTemplateDialog.Silent) {//kt and (not uInit.TimedOut)} then
            begin
...
//      TORCheckBox(ctrl).Caption := StringOut;
      //kt UpdateColorsFor508Compliance(ctrl);
