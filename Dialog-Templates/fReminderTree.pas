...
type
  ...
  *)
  ...
  TfrmReminderTree = class(TForm)
    ...
    mnuExit: TMenuItem;
    //kt imgLblReminders: TVA508ImageListLabeler;
  ...
  private
    //kt tvRem508Manager : TtvRem508Manager;
    FLinking: boolean;
    FSortOrder: integer;
...
begin
  //kt FixHeaderControlDelphi2006Bug(hcRem);
...
//  NotifyWhenProcessingReminderChanges(PositionToReminder);
  ...
  //kt tvRem508Manager := TtvRem508Manager.Create;
  //kt amgrMain.ComponentManager[tvRem] := tvRem508Manager;
end;
...
begin
  //kt EditCoverSheetReminderList(not CanEditAllRemCoverSheetLists);
end;
