object frmBroker: TfrmBroker
  ...
  object pnlTop: TORAutoPanel
    ...
    object cbAlwaysShowLatest: TCheckBox
      Left = 8
      Top = 53
      Width = 209
      Height = 17
      Caption = 'Always Show Latest RPC Call'
      TabOrder = 10
    end
    object cbAlignResultPieces: TCheckBox
      Left = 200
      Top = 53
      Width = 129
      Height = 17
      Caption = 'Align Result Pieces'
      TabOrder = 11
      OnClick = cbAlignResultPiecesClick
    end
  end
